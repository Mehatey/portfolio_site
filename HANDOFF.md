...
**Homepage (`_layouts/sid_home.html`)** — the scroll was rebuilt because the old six-card grid just repeated "work, work, work". Order is now: hero film → **`home_cinema.html`** (01) → `.hs-stats` (02) → **`home_cube.html`** (03) → `.hs-univ` (04).

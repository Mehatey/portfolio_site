    ...
    if (PCDheader.data === "binary_compressed") {
      ...
      for (let i = 0; i < PCDheader.points; i++) {
        if (offset.x !== undefined) {
          ...
          position.push(
            this._getDataView(dataview, PCDheader.points * offset.x + PCDheader.size[xIndex] * i, PCDheader.type[xIndex], PCDheader.size[xIndex])
          );
          position.push(
            this._getDataView(dataview, PCDheader.points * offset.y + PCDheader.size[yIndex] * i, PCDheader.type[yIndex], PCDheader.size[yIndex])
          );
          position.push(
            this._getDataView(dataview, PCDheader.points * offset.z + PCDheader.size[zIndex] * i, PCDheader.type[zIndex], PCDheader.size[zIndex])
          );
        }

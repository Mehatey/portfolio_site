...
layout: project
permalink: /ai-self/
project_title: AI SELF_ VR
proj_num: "01"
tagline: A VR narrative experience where an AI attempts to understand humanity by rebuilding it through memory, conflict, and choice.
category: VR · Narrative
year: 2024
...
meta:
  ...
  - label: Year
    value: 2024
  - label: Tools
    value: Unity · XR Interaction Toolkit
  - label: Client
    value: Self Initiated
reflection: >
  First deep exploration into VR, learning by building and understanding how interaction, space, and narrative come together.
next_project:

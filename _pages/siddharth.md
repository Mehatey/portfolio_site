...
<section class="reel-ch">
  ...
  <div class="reel-strip" aria-label="AI experiments">
    <div class="reel-strip__track">
          <div class="reel-plate"><video autoplay muted loop playsinline preload="metadata" poster="{{ B }}/assets/media/ai-prototypes/latent-atlas/module-02-semantic-search-web-poster.webp"><source src="{{ B }}/assets/media/ai-prototypes/latent-atlas/module-02-semantic-search-web.mp4" type="video/mp4" /></video></div>
          ...
          <div class="reel-plate"><video autoplay muted loop playsinline preload="metadata" poster="{{ B }}/assets/media/ai-prototypes/mimic/MIMIC-walkthrough-poster.webp"><source src="{{ B }}/assets/media/ai-prototypes/mimic/MIMIC-walkthrough.mp4" type="video/mp4" /></video></div>
          ...
          <div class="reel-plate"><video autoplay muted loop playsinline preload="metadata" poster="{{ B }}/assets/media/ai-prototypes/flatten/f3-poster.webp"><source src="{{ B }}/assets/media/ai-prototypes/flatten/f3.mp4" type="video/mp4" /></video></div>
          <div class="reel-plate"><video autoplay muted loop playsinline preload="metadata" poster="{{ B }}/assets/media/ai-prototypes/mirror/p5-poster.webp"><source src="{{ B }}/assets/media/ai-prototypes/mirror/p5.mp4" type="video/mp4" /></video></div>

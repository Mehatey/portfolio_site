---
layout: project
permalink: /unreal-game/
project_title: Unreal Game
proj_num: "07"
tagline: Step inside your own memories. Navigate fragmented spaces representing parts of the self.
category: Game · VR
year: 2025
hero_bg: "radial-gradient(ellipse at 40% 60%, #0a0d1a 0%, #050710 50%, #010205 100%)"
meta:
  - label: Role
    value: Solo
  - label: Year
    value: 2025
  - label: Tools
    value: Unreal Engine · VR Interaction
reflection: >
  Had to restart three weeks in after a crash, which changed approach to workflow and versioning.
next_project:
  title: Chainge AI
  url: /chainge-ai/
---
...
<div class="cs-bleed-cap">
  <span></span>
  <span class="cap-text">Unreal Engine · VR Interaction</span>
</div>

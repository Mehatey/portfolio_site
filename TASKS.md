# Open list — from Sid, 5 Sep

Working order is roughly top to bottom: cheap corrections first (they are
visible immediately and several are outright bugs), then the rebuilds, then
the two big interactive pieces.
